...
# ifdef _TFC	// TFC models override HL models
		...
		{ "models/p_9mmhandgun.mdl",		"models/v_barney9mmhg.mdl"	},//edit Alex "+barney"
		{ "models/p_grenade.mdl",		"models/v_barneygrenade.mdl"		},//edit Alex "+barney"
		{ "models/p_hgun.mdl",			"models/v_hgun.mdl"			},
		{ "models/p_9mmAR.mdl",			"models/v_barney9mmar.mdl"		},//edit Alex "+barney"
		{ "models/p_357.mdl",			"models/v_357.mdl"			},
		{ "models/p_rpg.mdl",			"models/v_rpg.mdl"			},
		{ "models/p_shotgun.mdl",		"models/v_barneyshotgun.mdl"		},//edit Alex "+barney"
